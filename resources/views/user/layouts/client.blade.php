                ...
                <div class="client-slider owl-theme owl-carousel">
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{URL::TO('designing/assets/images/client/client01.png')}}" alt="client">
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{URL::TO('designing/assets/images/client/client02.png')}}" alt="client">
                                </a>
                            </div>
                            <div class="content">
                    ...
                    <div class="client-item">
                        ...
                        <div class="client-author">
                            <div class="thumb">
                                <a href="#0">
                                    <img src="{{URL::TO('designing/assets/images/client/client03.png')}}" alt="client">
                                </a>
                            </div>
                            <div class="content">
