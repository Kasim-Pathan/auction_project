...
$start = carbon::parse($product->auction_start);
$end = carbon::parse($product->auction_end);
@endphp
@section('main')
        ...
        <div class="product-details-slider-wrapper">
            <div class="product-bottom-slider owl-theme owl-carousel" id="sync2">
                <div class="slide-bottom-item">
                    <div class="slide-inner">
                        <img src="{{asset($product->optional_image)}}" alt="product">
                    </div>
                </div>
                <!-- Repeat the above block for additional images if needed -->
            </div>
                ...
                <div class="product-details-content">
                    ...
                    <ul class="price-table mb-30">
                        <li class="header">
                            ...
                            <h3 class="price">₹{{$product->bid_price}}</h3>
                        </li>
                        <li>
                    ...
                    <div class="product-bid-area">
                        <div class="product-bid-form">
                            <div class="search-icon">
                                <img src="{{asset('designing/assets/images/product/search-icon.png')}}" alt="product">
                            </div>
                            <input type="text" placeholder="Enter your bid amount">
                            @if ($currentTime->between($start, $end))
                            <button type="submit" class="custom-button" disabled>Submit a bid</button>
                            @else
                            <a href="{{route('place_bid',$product->id)}}" class="custom-button">
                    ...
                    <div class="buy-now-area">
                        <a href="#0" class="custom-button">Buy Now: ₹{{$product->price}}</a>
                    ...
                    <div class="product-single-sidebar mb-3">
                        ...
                        <div class="side-counter-area">
                            <div class="side-counter-item">
                                <div class="thumb">
                                    <img src="{{asset('designing/assets/images/product/icon1.png')}}" alt="product">
                                </div>
                                <div class="content">
                            ...
                            <div class="side-counter-item">
                                <div class="thumb">
                                    <img src="{{asset('designing/assets/images/product/icon2.png')}}" alt="product">
                                </div>
                                <div class="content">
                            ...
                            <div class="side-counter-item">
                                <div class="thumb">
                                    <img src="{{asset('designing/assets/images/product/icon3.png')}}" alt="product">
                                </div>
                                <div class="content">
            ...
            <ul class="product-tab-menu nav nav-tabs">
                <li>
                    <a href="#details" class="active" data-toggle="tab">
                        <div class="thumb">
                            <img src="{{asset('designing/assets/images/product/tab1.png')}}" alt="product">
                        </div>
                ...
                <li>
                    <a href="#delevery" data-toggle="tab">
                        <div class="thumb">
                            <img src="{{asset('designing/assets/images/product/tab2.png')}}" alt="product">
                        </div>
                ...
                <li>
                    <a href="#history" data-toggle="tab">
                        <div class="thumb">
                            <img src="{{asset('designing/assets/images/product/tab3.png')}}" alt="product">
                        </div>
                ...
                <li>
                    <a href="#questions" data-toggle="tab">
                        <div class="thumb">
                            <img src="{{asset('designing/assets/images/product/tab4.png')}}" alt="product">
                        </div>
        ...
        <div class="tab-content">
                        ...
                        <div class="history-table-area">
                            <table class="history-table">
                                ...
                                <tbody>
                                    ...
                                    <!-- Repeat the above block for additional bid history entries if needed -->
                                </tbody>
                            </table>
            ...
            <div class="tab-pane fade show" id="questions">
                ...
                <div class="faq-wrapper">
                    ...
                    <!-- Repeat the above block for additional FAQ entries if needed -->
                </div>
            </div>
        </div>
    </div>
